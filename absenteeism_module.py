...
# create the special class that  are going to use from here on to predict new data
class absenteeism_model():
        ...
        def load_and_clean_data(self, data_file):
            ...
            # to preserve the code that have created in the previous section, add a column with 'NaN' strings
